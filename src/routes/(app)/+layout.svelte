...
<div class="wrapper min-h-screen max-w-[100dvw]">
  <header
    class="flex justify-between sm:grid sm:grid-cols-3 justify-items-center items-center w-full py-2 px-4 dark:text-white"
  >
    <div class="justify-self-start w-12">
      <a href="/">
        <Ow2CountdownLogo />
      </a>
    </div>
    <nav
      class="flex gap-4 sm:gap-10 text-lg sm:text-2xl items-center justify-center"
    >
    ...
    <div
      class="justify-self-end flex items-center justify-center gap-4 text-2xl"
    >
      <a href="/discord" target="_blank"><DiscordIcon /></a>
      <a href="/feed.xml" target="_blank"><RssFeedIcon /></a>
      <a
        href="https://github.com/CactusPuppy/ow2countdown"
        target="_blank"
        rel="noreferrer noopener"><GitHubIcon /></a
      >
    </div>
  </header>
  ...
  >
    <p class="text-xs text-zinc-500 dark:text-zinc-400 text-left">
      Created by CactusPuppy | <a
        href="https://github.com/CactusPuppy/ow2countdown"
        rel="noreferrer noopener"
        target="_blank"
        class="text-ow2-orange dark:text-ow2-light-orange underline">GitHub</a
      ><br />
      <a
        href="/privacy-policy"
