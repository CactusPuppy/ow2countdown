...
<svelte:head>
  ...
  <meta
    name="og:title"
    content="OW2Countdown.com | Live countdowns to important Overwatch 2 events"
  />
  <meta
    name="og:description"
    content="Count down the time left until important Overwatch 2 events while seeing the times in your timezone! Visit an event page to get more information about the event, or copy the date and time down for later use."
  />
