...
<div class="wrapper min-h-[100vh] max-w-full overflow-x-hidden mx-2">
  ...
  >
    <p class="text-xs text-zinc-500 dark:text-zinc-400 italic text-left">Created by <span class="text-ow2-orange dark:text-ow2-light-orange">CactusPuppy</span><br /><a href="https://github.com/CactusPuppy/ow2countdown" rel="noreferrer noopener" target="_blank" class="text-ow2-orange dark:text-ow2-light-orange underline">GitHub</a></p>
