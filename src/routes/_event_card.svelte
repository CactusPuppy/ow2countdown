...
<div
  ...
  <p
    ...
    {#if date.id !== -1}
      <a
        class="inline sm:absolute sm:right-0 sm:top-0 sm:mr-4 sm:mt-3 px-2 py-1 bg-zinc-500 hover:bg-zinc-400 dark:bg-zinc-700 dark:hover:bg-zinc-600 text-zinc-200 rounded-md text-lg"
